...
/**
 * @brief The CustomCourseDelegate class Serves as an adapter for binding and displaying student data
 * @author Qian
 * @since 1.0.0
 */
class CustomStudentDelegate : public QStyledItemDelegate {
public:
    void paint(QPainter *painter, const QStyleOptionViewItem &option,
        ...
        rect = option.rect.adjusted(550, 0, 0, 0);
