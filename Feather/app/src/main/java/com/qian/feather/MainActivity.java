...
import com.qian.feather.Activity.AddNewFriendActivity;
 ...
 */
            ...
            public void onPageSelected(int position) {
                ...
                switch (position) {
                    case 1:
                        ...
                        Utils.sendMessageToHandler(handler,"联系人",fragmentChanged);
                        break;
                    case 2:
                        currentFragmentIndex = 2;
                        Utils.sendMessageToHandler(handler,"我",fragmentChanged);
        ...
        handler = new Handler(Looper.myLooper()) {
            public void handleMessage(Message message) {
                if(message.what == fragmentChanged) {
                    if("Self".equals(message.obj) || "我".equals(message.obj)) {
    ...
    class MainGestureDetector extends GestureDetector {

        public MainGestureDetector(@Nullable Context context, @NonNull OnGestureListener listener) {
            super(context, listener);
        }

        public MainGestureDetector(@Nullable Context context, @NonNull OnGestureListener listener, @Nullable Handler handler) {
